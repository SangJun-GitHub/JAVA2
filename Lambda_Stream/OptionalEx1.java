...
public class OptionalEx1 {
    public static void main(String[] args) {
        ...
        OptionalInt optInt1 = OptionalInt.of(0);                        //save 0
        OptionalInt optInt2 = OptionalInt.empty();                      //create empty object
...
//        System.out.println(optInt2.getAsInt());                       //NoSuchElementException
        ...
        Optional<String> opt = Optional.ofNullable(null);               //save null
